package main.ds.tree.trie.common.substring.suffix;

import java.util.*;

public class SimplifiedSuffixTree {
    static class Node {
    ...
    public SimplifiedSuffixTree(String text) {
        this.text = text;
        buildSuffixTree();
    }
    ...
    public static void main(String[] args) {
        String text = "banana";
        SimplifiedSuffixTree suffixTree = new SimplifiedSuffixTree(text);
